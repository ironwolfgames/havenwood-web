# Houses of Havenwood — Physical Prototype Kit

This document contains all the necessary information to create a physical prototype of **Houses of Havenwood**.

## 1. Cards

### A. Shared Action Deck (80 Cards)

**Starter Cards (40 Cards - 10 per Player)**
*Each player receives one set of these 10 cards.*

| Card Name | Count (Total) | Action Effect |
| :--- | :--- | :--- |
| **Build** | 8 | Perform a **Build** action. |
| **Move (Level 1)** | 4 | **Move**. Move up to 1 space. |
| **Move (Level 2)** | 4 | **Move**. Move up to 2 spaces. |
| **Buy Card** | 8 | Perform a **Buy Card** action. |
| **Main Action** | 8 | Perform your House's **Main Action**. |
| **Auxiliary Action** | 8 | Perform your House's **Auxiliary Action**. |

**Market Cards (40 Cards)**
*Shuffle these to form the Market Deck.*
...
### B. Event Deck (40 Cards)

*Shuffle these to form the Event Deck.*
...
### C. Squirrel Production Deck (20 Cards)

*Used by the Squirrel House for the Produce action.*
...
### D. Owl Research Decks (60 Cards)

*Used by the Owl House for the Research action. Cards do not have titles.*
...
### E. Miscellaneous Cards

**Fear Cards (10 Cards)**

| Card Name | Count | Effect |
| :--- | :--- | :--- |
| **Fear** | 10 | **Unplayable.** Cannot be played. Takes up hand space. |

**Great Works Component Cards (22 Cards)**
*Select one set of cards for the chosen Great Work for the game.*
...
| :--- | :--- | :--- | :--- |
| **Central Havenwood** | 1 | None (Safe Zone) | None (Starting Tile) |
...
1.  **Squirrel Player Mat**: Tracks building costs, harvest dice rules.
2.  **Fox Player Mat**: Tracks building costs, exploration stats (N/M), wall/shield rules.
3.  **Owl Player Mat**: Tracks building costs, research limit, display size (N).
4.  **Badger Player Mat**: Tracks Great Work info, Lead action costs.
5.  **Badger Worker Placement Board**: Spaces for Construct, Train, Ensure Quality, Install, Commission.
6.  **Tech & Magic Tree Board**: Tracks for Knowledge/Insight and slots for unlocked tech cards/markers.
7.  **Threat/Storm Track Board**: Track with 15 spaces (1-6: Draw 1, 7-12: Draw 2, 13-14: Draw 3, 15: Loss).
...
**House Markers**
*   4 House Markers (Squirrel, Fox, Owl, Badger) for the map.
*   3 Badger Worker Meeples.
*   Fox Wall/Fortification Tokens (Levels 1-3).
*   Magic Shield Tokens.
...
*   **10x Harvest Dice (Squirrels)**: Custom d6s [1, 2, 3, Bust, Bust, Blank].
*   **6x Quality Dice (Badgers)**: Standard d6s [1-6].
